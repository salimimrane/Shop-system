   ...
   <p>Please enter your email and password</p>
    ...
    <form method="POST" action="connect1.php" >	
        <div class="form-group">
            <input type="email" class="form-control" id="mail" name="mail"placeholder="Email Address" required="true">
        </div>
        <div class="form-group">
            <input type="" class="form-control" id="name" name="name"placeholder="Name" required="true">
        </div>
